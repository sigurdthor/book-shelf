...
/**
  * This is an event sourced entity. It has a state, [[BookshelfState]], which
...
class BookEntity extends PersistentEntity {
  ...
  override type Command = BookshelfCommand[_]
  override type Event = BookshelfEvent
  override type State = BookshelfState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: BookshelfState = BookshelfState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case BookshelfState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        BookshelfState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class BookshelfState(message: String, timestamp: String)
...
object BookshelfState {
  /**
    ...
    */
  implicit val format: Format[BookshelfState] = Json.format
}

/**
  * This interface defines all the events that the BookshelfEntity supports.
  */
sealed trait BookshelfEvent extends AggregateEvent[BookshelfEvent] {
  def aggregateTag: AggregateEventTag[BookshelfEvent] = BookshelfEvent.Tag
}

object BookshelfEvent {
  val Tag: AggregateEventTag[BookshelfEvent] = AggregateEventTag[BookshelfEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends BookshelfEvent
...
/**
  * This interface defines all the commands that the BookshelfEntity supports.
  */
sealed trait BookshelfCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends BookshelfCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends BookshelfCommand[String]
...
/**
  ...
  * application loader.
  */
object BookshelfSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[BookshelfState]
  )
}
